...
//so they can choose a different size. Return an array named largeShirts that contains information about the runners that have 
//a shirt size of L and log the result
// let largeShirts = [];

const largeShirtsOnly= runners.filter (function (shirts) {
    return shirts.shirt_size === "L"
});

console.log(largeShirtsOnly);
